...
<div class="card border-dark" style="margin:1%;position:absolute;top:7.5%" id="mainDiv">
	<div class="card-header bg-dark text-white" align="center">{{authorName}} பதிலளித்த கேள்விகள்</div>
	<div class="card-body">
...
<script type="text/javascript">
	const componentVar = {
		...
		mounted(){
			...
			xhttp.open("GET", "<?php echo base_url('index.php/answer/getAnswersOfUserWithItsQuestionForViewing?authorID='.$_GET['userid']); ?>", true);
			xhttp.send();
		}
	}
