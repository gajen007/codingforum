...
<div class="card border-dark" style="margin:1%;position:absolute;top:7.5%;width:98%" id="mainDiv">
	<div class="card-header bg-dark text-white" align="center">நீங்கள் பின்தொடரும் கேள்விகள்</div>
	<div class="card-body">
...
<script type="text/javascript">
	const componentVar = {
		...
		mounted(){
			...
			xhttp.open("GET", "<?php echo base_url('index.php/question/getFollowingQuestionsOfUser?userName='.$username); ?>", true);
			xhttp.send();
		}
	}
